package shengzheng.educationapp.CustomCalendar;
...
public class CalendarView extends LinearLayout implements OnClickListener {
	...
	private CalendarAdapter calV = null;      //日历适配其
	private ViewFlipper flipper = null;
	private GridView gridView = null;
	private static int jumpMonth = 0; // 每次滑动，增加或减去一个月,默认为0（即显示当前月）
	private static int jumpYear = 0; // 滑动跨越一年，则增加或者减去一年,默认为0(即当前年)
	private ClickDataListener clickDataListener;//选中日期的监听事件
	...
	private void addGridView() {
		...
		Display display = windowManager.getDefaultDisplay();//得到显示屏
